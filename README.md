...
2. [Scenario](#scenario)
3. [Controls Checklist](#controls-checklist)
4. [Compliance Checklist](#compliance-checklist)
5. [Recommendations for Improving Botium Toys’ Security Posture](#recommendations-for-improving-botium-toys-security-posture)
6. [Compliance Specific Recommendations](#compliance-specific-recommendations)
